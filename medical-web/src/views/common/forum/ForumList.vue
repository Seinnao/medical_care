<template>
  <div>
    <div style="margin: 10px 0">
      ...
      <el-input style="width: 200px" clearable placeholder="请输入用户名" suffix-icon="el-icon-s-custom" class="ml-5" v-model="nickname"></el-input>
    ...
    <el-table :data="tableData" border stripe
      ...
      <el-table-column label="操作"  width="200" align="center">
        <template slot-scope="scope">
          <el-button type="primary" @click="see(scope.row)">查看 <i class="el-icon-view"></i></el-button>
          <el-popconfirm
              class="ml-5"
              confirm-button-text='确定'
              cancel-button-text='我再想想'
